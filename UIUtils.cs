...
namespace DistrictServiceLimit
{
    public class UIUtils
    {
        ...
        public static UICheckBox CreateCheckBox(UIComponent parent)
        {
            ...
            sprite.relativePosition = new Vector3(8f, 6f);
            ...
            checkBox.label.text = " ";
            checkBox.label.textScale = 0.75f;
            checkBox.label.relativePosition = new Vector3(30f, 8f);
            checkBox.label.color = new Color32(255, 255, 255, 200);
